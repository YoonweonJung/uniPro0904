...
<body>
	...
	<div class="my_box">
		...
		<div class="form-group">
				<label class="control-label col-sm-2" for="input_name">아이디 : </label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="input_email">이메일 : </label>
				<div class="col-sm-10">
